...
def main():
    ...
    # Do not copy blindly, you need to understand what you are doing.
    # For a blind copy you will get 0 points.
    ...
    # convert Tokenizers tokenizer object into Transformers tokenizer object
    target_tokenizer = transformers.PreTrainedTokenizerFast(
        tokenizer_object=target_tokenizer,
        bos_token="[BOS]",
        eos_token="[EOS]",
